-- ============================================
-- Table: dbo.SchwabQuotesHistory_Summary
-- Database: PBI_Projects
-- Generated: 2026-05-01 15:21:04
-- ============================================

IF OBJECT_ID('dbo.SchwabQuotesHistory_Summary', 'U') IS NOT NULL
    DROP TABLE dbo.SchwabQuotesHistory_Summary;
GO
CREATE TABLE dbo.SchwabQuotesHistory_Summary (
