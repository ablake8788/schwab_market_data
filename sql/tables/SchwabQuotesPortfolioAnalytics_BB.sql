-- ============================================
-- Table: dbo.SchwabQuotesPortfolioAnalytics_BB
-- Database: PBI_Projects
-- Generated: 2026-05-01 15:21:05
-- ============================================

IF OBJECT_ID('dbo.SchwabQuotesPortfolioAnalytics_BB', 'U') IS NOT NULL
    DROP TABLE dbo.SchwabQuotesPortfolioAnalytics_BB;
GO
CREATE TABLE dbo.SchwabQuotesPortfolioAnalytics_BB (
