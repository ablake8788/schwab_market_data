-- ============================================
-- Table: dbo.SchwabQuotesAnalyticsBollingerBandsSQL
-- Database: PBI_Projects
-- Generated: 2026-05-01 15:21:03
-- ============================================

IF OBJECT_ID('dbo.SchwabQuotesAnalyticsBollingerBandsSQL', 'U') IS NOT NULL
    DROP TABLE dbo.SchwabQuotesAnalyticsBollingerBandsSQL;
GO
CREATE TABLE dbo.SchwabQuotesAnalyticsBollingerBandsSQL (
